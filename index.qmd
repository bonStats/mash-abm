...
-   [Section 4: Bayesian workflow and Stan](lectures/abm4.html) [Reading: @gelman2020bayesian, Ch 2.7 @gelman2013bayesian]
...
-   [Worksheet 4](worksheets/scripts/worksheet4.R) and [initial Stan file](worksheets/scripts/kidney_global.stan)
...
`r download_data_buttom("kidneycancerclean.csv","kidneycancerclean")` Death rates
